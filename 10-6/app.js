...
let [raindrops, whiskers, ...aFewOfMyFavoriteThings] = [
  ...
  console.log(aFewOfMyFavoriteThings); // ? //Answer: ['Bright copper kettles', 'warm wollen mittens', 'Brown paper packages tied up with strings']
...
console.log(raceResults([1,2,3,4,5,6,7,8,9]));
